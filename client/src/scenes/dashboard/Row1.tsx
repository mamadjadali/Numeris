        ...
        <>
            <DashboardBox gridArea="a">
                <BoxHeader
                    ...
                    subtitle="top line repersent revenue, bottom line repersent expenses"
                    sideText="+4%"
                />
            ...
            <DashboardBox gridArea="c">
                <BoxHeader
                    ...
                    subtitle="graph repersent revenue"
                    sideText="+4%"
                />
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart
                    ...
                    >
                        ...
                        <Tooltip />
                        <Bar dataKey="revenue" fill="url(#colorRevenue)" activeBar={<Rectangle fill="green" stroke="blue" />} />
                    </BarChart>
                </ResponsiveContainer>
            </DashboardBox>
        </>
